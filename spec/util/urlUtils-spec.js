...
describe('Url Utils', () => {
  it('should construct the sheet url', () => {
    ...
    expect(sheetUrl).toStrictEqual(
      'https://thoughtworks.com/radar?documentId=documentId&sheetName=radar',
    );
  ...
  it('should construct the sheet url if sheetId is used', () => {
    ...
    expect(sheetUrl).toStrictEqual(
      'https://thoughtworks.com/radar?sheetId=sheetId&sheetName=radar',
    );
    expect(queryParams).toHaveBeenCalledTimes(1);
  });

  it('should prioritize documentId before legacy sheetId', () => {
    queryParams.mockReturnValue({
    ...
    window.location.href =
      'https://thoughtworks.com/radar?documentId=documentId&sheetId=sheetId';
    window.location.search = '?';
  ...
  it('supports documentId', () => {
    ...
    window.location = Object.create(window);
    window.location.href =
      'https://thoughtworks.com/radar?documentId=documentId';
    window.location.search = '?';
