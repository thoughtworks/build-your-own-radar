[Teamcity](https://www.jetbrains.com/teamcity/) is a build system. Built by the folks at Jetbrains it provides all the functionality needed for continuous integration.
