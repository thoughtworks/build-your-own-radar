[Github](https://github.com/) is a platform to host all of your git based repositories. By extension [git](https://git-scm.com) should be used as your distributed version control system.  
