The [Active Warehouse (Ruby)](https://github.com/activewarehouse/activewarehouse) library provides classes and functions which help with building Data Warehouses using Rails.
