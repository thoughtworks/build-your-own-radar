[React Hooks](https://reactjs.org/docs/hooks-overview.html) are functions that let you “hook into” React state and lifecycle features from function components.
