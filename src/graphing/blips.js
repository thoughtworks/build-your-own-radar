...
const findExistingBlipCoords = (ringIndex, deg) => {
...
const groupBlipsBaseCoords = (ringIndex) => {
...
const transposeQuadrantCoords = (coords, blipWidth) => {
  const transposeX =
...
const plotRadarBlips = (parentElement, rings, quadrantWrapper, tooltip) => {
