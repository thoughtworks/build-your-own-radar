...
const GoogleAuth = () => {
  ...
  self.loadGoogle = (forceLogin = false, callback) => {
  ...
  self.gsiCallback = async (credentialResponse) => {
    let jwToken;
  ...
  self.gsiLogin = async (forceLogin = false) => {
    self.forceLogin = forceLogin;
