...
const plotRadar = function (title, blips, currentRadarName, alternativeRadars) {
  ...
  _.each(blips, function (blip) {
    ...
    quadrants[blip.quadrant].add(
      new Blip(blip.name, ringMap[blip.ring], blip.isNew.toLowerCase() === 'true', blip.hasMovedIn.toLowerCase() === 'true', blip.hasMovedOut.toLowerCase() === 'true', blip.topic, blip.description),
    )
  })
  ...
  blips.forEach((blip) => {
    ...
    if (currentQuadrant && ring) {
      const blipObj = new Blip(
        ...
        blip.hasMovedIn.toLowerCase() === 'true',
        blip.hasMovedOut.toLowerCase() === 'true',
        blip.topic,
        blip.description,
      )
