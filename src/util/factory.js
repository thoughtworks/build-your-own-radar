...
const plotRadar = function (title, blips, currentRadarName, alternativeRadars) {
  ...
  _.each(blips, function (blip) {
    ...
    quadrants[blip.quadrant].add(new Blip(blip.name, blip.author, ringMap[blip.ring], blip.isNew.toLowerCase() === 'true', blip.topic, blip.description))
  })
  ...
  var size = (window.innerHeight - 75) < 620 ? 620 : window.innerHeight - 75
...
function plotLoading (content) {
  ...
  var bannerText = '<h1>Building the radar...</h1><p>The Technology Radar will be available in just a few seconds</p>'
  plotBanner(content, bannerText)
  plotFooter(content)
}
...
function plotLogo (content) {
  content.append('div')
    ...
    .html('<a href="https://weareyou.com"><img src="/images/weareyou_logo_rgb@2x.png" / ></a>')
}
